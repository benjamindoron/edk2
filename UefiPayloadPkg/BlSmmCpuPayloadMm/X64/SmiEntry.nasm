...
global ASM_PFX(gPatchEdk2PayloadMmPrivateData)
...
global ASM_PFX(PayloadMmTransferExecFixupAddress)
ASM_PFX(PayloadMmTransferExecFixupAddress):
    lea    eax, [ASM_PFX(gPatchEdk2PayloadMmPrivateData)]
    lea    rcx, [gPatchEdk2PayloadMmPrivateDataAbsAddr]
    mov    dword [rcx - 4], eax
...
global ASM_PFX(ModeSwitchCallMmCore)
ASM_PFX(ModeSwitchCallMmCore):
BITS 32
    ; Switch stack
    mov     ecx, esp
    mov     edx, ebp
    ...
    ; Acquire internal private data
    mov     ebx, strict dword 0         ; source operand will be patched
ASM_PFX(gPatchEdk2PayloadMmPrivateData):
